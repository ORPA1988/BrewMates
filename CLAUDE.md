...
| Wie sieht der österreichische Biermarkt aus, was schreibt das Recht vor? | [docs/15 — Bier in Österreich](docs/15-bier-in-oesterreich.md) |
...
- **Version:** `0.10.31-beta+51` (Beta 0.x bis zum Play-Store-1.0; der
